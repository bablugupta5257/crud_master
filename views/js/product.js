...
function loaddata() {
  $.ajax({
    url: "http://localhost:3000/product/get",
    type: "GET",
...
function getPagination() {
  $.ajax({
    url: "http://localhost:3000/product/pagination",
    type: "GET",
    success: function (data) {
      if (data.count > 8) {
...
function loadEndPage(num) {
  $.ajax({
    url: `http://localhost:3000/endpage`,
    type: "GET",
    success: function (data) {
      populateData(data);
      pgno = parseInt(num);
...
function goLeft() {
  ...
  $.ajax({
    url: `http://localhost:3000/get/${id}/left`,
    type: "GET",
    success: function (data) {
      populateData(data);
    },
...
function goRight() {
  ...
  $.ajax({
    url: `http://localhost:3000/get/${id}/right`,
    type: "GET",
    success: function (data) {
      populateData(data);
    },
